    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-(--bg-card)">
        <div className="w-full max-w-[360px]">
          ...
          <div className="mb-8">
            <h1 className="text-[26px] font-semibold text-(--fg)">{t("welcomeBack")}</h1>
          ...
          <div className="space-y-3">
            ...
            <form action={googleAction}>
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-(--border) rounded-xl text-(--fg) text-sm font-medium hover:bg-(--bg) transition-colors"
              >
