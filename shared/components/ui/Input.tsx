    ...
    return (
      <div className="space-y-1.5">
        ...
        <input
          ref={ref}
          id={id}
          className={`w-full px-3 py-2.5 rounded-xl border text-sm text-[var(--fg)] placeholder:text-[var(--fg-muted)] bg-[var(--input-bg)] focus:outline-none focus:ring-2 transition-colors ${
            error
